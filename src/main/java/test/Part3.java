...
public class Part3 {
    public static void Task7() throws IOException {
        ...
        for (int i = 28; i < 33; i++) {
            system.students.add(new Student(""+i, "", 1, 4, List.of("PHYS1001"), null));
        }
    ...
    public static void Task8() throws IOException {
        ...
        // yes
        for (int i = 0; i < 9; i++) {
            system.students.add(new Student(""+i, "", 1, 4, List.of("ELEC1001", "COMP2011", "BIEN1000"), null));
        }
        // no
        Student t1 = new Student(""+10, "ECE", 1, 4, List.of("MATH1001", "PHYS1001", "ELEC1001", "COMP2011"), null);
        Student t2 = new Student(""+11, "CSE", 1, 4, List.of("MATH1001", "PHYS1001", "ELEC1001", "COMP2011"), null);
        Student t4 = new Student(""+13, "CSE", 1, 4, List.of("MATH1001", "PHYS1001", "BIEN1000"), null);
        // yes
        Student t3 = new Student(""+12, "CBE", 1, 4, List.of("MATH1001", "PHYS1001", "BIEN1000"), null);
    ...
    public static void Task9() throws IOException {
        ...
        for (int i = 0; i < 9; i++) {
            system.students.add(new Student(""+i, "", 1, 4, List.of("ELEC1001", "COMP2011", "BIEN1000", "MATH1001"), null));
        }
        Student t1 = new Student(""+10, "ECE", 1, 4, List.of("MATH1001", "PHYS1001", "ELEC1001", "COMP2011"), null);
        Student t2 = new Student(""+11, "CSE", 1, 4, List.of("MATH1001", "PHYS1001", "ELEC1001", "COMP2011"), null);
        system.students.add(t1);
        ...
        if (!system.courses.get("BIEN1000").getWaitlist().contains(t4.getStudentID()))
            throw new AssertionError();
        for (int i = 6; i < 9; i++) {
            if (system.courses.get("MATH1001").getWaitlist().contains(t4.getStudentID()))
                throw new AssertionError();
        }
    }
